...
<div className="login-wrapper" id="login-content">
    <div className="login-content">
        <a href="localhost" className="close">x</a>
        <h3>Login</h3>
        <form method="post" action="#">
            ...
            <div className="row">
            	<div className="remember">
            		...
            		<a href="localhost">Forget password ?</a>
            	</div>
            </div>
           <div className="row">
        ...
        <div className="row">
            ...
            <div className="social-btn-2">
            	<a className="fb" href="localhost"><i className="ion-social-facebook"></i>Facebook</a>
            	<a className="tw" href="localhost"><i className="ion-social-twitter"></i>twitter</a>
            </div>
        </div>
    </div>
</div>
		...
		<nav className="navbar navbar-default navbar-custom">
				...
				<div className="collapse navbar-collapse flex-parent" id="bs-example-navbar-collapse-1">
					...
					<ul className="nav navbar-nav flex-child-menu menu-right">
						...
						<li><a href="localhost">Help</a></li>
						<li className="loginLink"><a href="localhost">LOG In</a></li>
						<li className="btn signupLink"><a href="localhost">sign up</a></li>
					</ul>
				</div>
	    </nav>
			...
			<div className="col-md-8 col-sm-12 col-xs-12">
				...
				<div className="movie-item-style-2">
					...
					<div className="mv-item-infor">
						...
						<p>Stars: <a href="localhost">Robert Downey Jr.,</a> <a href="localhost">Chris Evans,</a> <a href="localhost">  Chris Hemsworth</a></p>
					</div>
				</div>
				<div className="movie-item-style-2">
					...
					<div className="mv-item-infor">
						...
						<p className="run-time"> Run Time: 2h21’    .     <span>MMPA: PG-13 </span>    .     <span>Release: 1 May 2015</span></p>
						<p>Director: <a href="localhost">Anthony Russo,</a><a href="localhost">Joe Russo</a></p>
						<p>Stars: <a href="localhost">Chris Evans,</a> <a href="localhost">Samuel L. Jackson,</a> <a href="localhost">  Scarlett Johansson</a></p>
					</div>
				</div>
				<div className="movie-item-style-2">
					...
					<div className="mv-item-infor">
						...
						<p className="run-time"> Run Time: 2h21’    .     <span>MMPA: PG-13 </span>    .     <span>Release: 1 May 2015</span></p>
						<p>Director: <a href="localhost">Peyton Reed</a></p>
						<p>Stars: <a href="localhost">Paul Rudd,</a> <a href="localhost"> Michael Douglas</a></p>
					</div>
				</div>
				<div className="movie-item-style-2">
					...
					<div className="mv-item-infor">
						...
						<p className="run-time"> Run Time: 2h21’    .     <span>MMPA: PG-13 </span>    .     <span>Release: 1 May 2015</span></p>
						<p>Director: <a href="localhost">Shane Black</a></p>
						<p>Stars: <a href="localhost">Robert Downey Jr., </a> <a href="localhost">  Guy Pearce,</a><a href="localhost">Don Cheadle</a></p>
					</div>
				</div>
				<div className="movie-item-style-2">
					...
					<div className="mv-item-infor">
						...
						<p className="describe">When Tony Stark's world is torn apart by a formidable terrorist called the Mandarin, he starts an odyssey of rebuilding and retribution.</p>
						<p className="run-time"> Run Time: 2h21’    .     <span>MMPA: PG-13 </span>    .     <span>Release: 1 May 2015</span></p>
						<p>Director: <a href="localhost">Alan Taylor</a></p>
						<p>Stars: <a href="localhost">Chris Hemsworth,  </a> <a href="localhost">  Natalie Portman,</a><a href="localhost">Tom Hiddleston</a></p>
					</div>
				</div>
				<div className="topbar-filter">
...
<footer className="ht-footer">
	<div className="container">
		<div className="flex-parent-ft">
			<div className="flex-child-ft item1">
				...
				New York, NY 10001</p>
				<p>Call us: <a href="localhost">(+01) 202 342 6789</a></p>
			</div>
			<div className="flex-child-ft item2">
				<h4>Resources</h4>
				<ul>
					<li><a href="localhost">About</a></li> 
					<li><a href="localhost">Blockbuster</a></li>
					<li><a href="localhost">Contact Us</a></li>
					<li><a href="localhost">Forums</a></li>
					<li><a href="localhost">Blog</a></li>
					<li><a href="localhost">Help Center</a></li>
				</ul>
			</div>
			<div className="flex-child-ft item3">
				<h4>Legal</h4>
				<ul>
					<li><a href="localhost">Terms of Use</a></li> 
					<li><a href="localhost">Privacy Policy</a></li>	
					<li><a href="localhost">Security</a></li>
				</ul>
			</div>
			<div className="flex-child-ft item4">
				<h4>Account</h4>
				<ul>
					<li><a href="localhost">My Account</a></li> 
					<li><a href="localhost">Watchlist</a></li>	
					<li><a href="localhost">Collections</a></li>
					<li><a href="localhost">User Guide</a></li>
				</ul>
			</div>
			<div className="flex-child-ft item5">
				...
				<a href="localhost" className="btn">Subscribe now <i className="ion-ios-arrow-forward"></i></a>
			</div>
		</div>
	</div>
	<div className="ft-copyright">
		...
		<div className="backtotop">
			<p><a href="localhost" id="back-to-top">Back to top  <i className="ion-ios-arrow-thin-up"></i></a></p>
		</div>
	</div>
</footer>
