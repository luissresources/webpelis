        ...
        <div className="blog-detail-ct">
          ...
          <div className="flex-it share-tag">
            <div className="social-link">
              <h4>Share it</h4>
              <a href="localhost"><i className="ion-social-facebook"></i></a>
              <a href="localhost"><i className="ion-social-twitter"></i></a>
              <a href="localhost"><i className="ion-social-googleplus"></i></a>
              <a href="localhost"><i className="ion-social-pinterest"></i></a>
              <a href="localhost"><i className="ion-social-linkedin"></i></a>
            </div>
            <div className="right-it">
              <h4>Tags</h4>
              <a href="localhost">Gray,</a>
              <a href="localhost">Film,</a>
              <a href="localhost">Poster</a>
            </div>
          </div>
          <div className="comments">
            ...
            <div className="cmt-item flex-it">
              ...
              <div className="author-infor">
                <div className="flex-it2">
                  <h6><a href="localhost">Steve Perry</a></h6> <span className="time"> - 27 Mar 2017</span>
                </div>
                ...
                <p><a className="rep-btn" href="localhost">+ Reply</a></p>
              </div>
            </div>
            <div className="cmt-item flex-it reply">
              ...
              <div className="author-infor">
                <div className="flex-it2">
                  <h6><a href="localhost">Joss Whedon</a></h6> <span className="time"> - 27 Mar 2017</span>
                </div>
            ...
            <div className="cmt-item flex-it reply">
              ...
              <div className="author-infor">
                <div className="flex-it2">
                  <h6><a href="localhost">Dave McNary</a></h6> <span className="time"> - 27 Mar 2017</span>
                </div>
            ...
            <div className="cmt-item flex-it">
              ...
              <div className="author-infor">
                <div className="flex-it2">
                  <h6><a href="localhost">Margot Robbie</a></h6> <span className="time"> - 27 Mar 2017</span>
                </div>
